...
{
    constexpr uint64_t MAX_CONST_BUFFER_SIZE = 128 * 1024 * 1024; // 128MB
    constexpr uint32_t kDefaultDescriptorCount = 64;
    constexpr uint32_t kDefaultFrameDescriptorCount = 4096 * 3;
    ...
    void RendererDX12::CreateRootSignature()
    {
        ...
        // Create root signature for Compute 
        {
            ...
            range[2].Init(D3D12_DESCRIPTOR_RANGE_TYPE_UAV, 4, 0);
